...
def main():
    fn1 = "../data/day17/test.txt"
    fn2 = "../data/day17/input.txt"

    t = Tunnel(fn1, 2022)
    print(t.highest_point)  # 3068

    t = Tunnel(fn1, 1_000_000_000_000)
    print(t.highest_point)  # 1514285714288

    t = Tunnel(fn2, 2022)
    print(t.highest_point)  # 3124

    t = Tunnel(fn2, 1_000_000_000_000)
    print(t.highest_point)  # 1561176470569
